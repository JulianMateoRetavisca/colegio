...
<section class="page-section">
    <div class="page-header">
        <div class="page-title">
            <h1 class="h4 mb-0"><i class="fas fa-user-edit me-2 text-primary"></i>Editar rol: {{ $rol->nombre }}</h1>
            <p class="subtitle">Modifica los permisos o la descripción del rol</p>
        </div>
        ...
        <form action="{{ route('roles.actualizar', $rol->id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="descripcion" id="descripcion" class="form-control" required value="{{ old('descripcion', $rol->descripcion) }}" @if($esRolSistema) readonly @endif>
                </div>
            </div>
            ...
            <div class="pro-card-footer d-flex justify-content-end gap-2 mt-3">
                ...
                <button type="submit" class="btn-pro success"><i class="fas fa-save me-1"></i>Actualizar rol</button>
            </div>
        </form>
    </x-form-card>
</section>
